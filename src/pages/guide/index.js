...
const guides = [
  ...
  {
    title: '이용 대상',
    content: '<em>20~29세의 대학생</em>이라면 누구나! 신청 가능합니다.😃',
  },
  {
    title: '신청 방법',
    content: `
  ...
  {
    title: '매칭까지의 기간',
    content: `스피드가 생명인 미팅!🏃🏻‍️ 미팅학개론은 <em>10팀이 채워질 경우 바로 매칭</em>을 시작합니다.<br/><br/>(단, 적합한 상대팀이 없는 경우 매칭이 지연될 수 있습니다.)`,
  },
  {
    title: '이용권 관련',
  ...
  },
  {
    title: '이용권 환불',
    content:
      '채널톡을 통해 문의 주시면 이용권 구매 후 10일 이내에 환불이 가능합니다.',
  },
  {
    title: '미팅 인원',
    content: `<em>2:2 혹은 3:3 팀으로만 미팅 참여가 가능합니다.</em><br/>아쉽게도 현재 미팅학개론 내에서 <1:1 소개팅>과 <4:4 미팅> 서비스는 지원하고 있지 않습니다.🥲`,
  },
  {
    title: '추가 문의',
    content:
      '기타 문의는 하단의 채널톡으로 문의 주시면 빠르게 답변해 드립니다. 🙌🏻',
  },
];
