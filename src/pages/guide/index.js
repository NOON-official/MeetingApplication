...
const guides = [
  ...
  },
  {
    ...
    3. 미팅을 위한 모든 준비가 끝났어요! 원하는 상대방이 나타나면 즉시 매칭됩니다. 매칭이 완료되는 대로 연락을
    드리니 설레는 마음으로 기다려 주세요!✨<br/><br/>
    🚩FINISH! 매칭된 상대팀의 미팅학개론을 확인하신 후 수락해 주세요. 이용권을 결제해 주신 뒤 상대팀도 수락하면 <em>단톡방까지 개설</em>해 드립니다.🤩`,
  },
  {
    title: '매칭까지의 기간',
    content: `스피드가 생명인 미팅!🏃🏻‍️ 미팅학개론은 <em>원하는 상대방이 나타나면 즉시 매칭</em>됩니다.<br/><br/>(단, 적합한 상대팀이 없는 경우 매칭이 지연될 수 있습니다.)`,
  },
  {
    title: '이용권 관련',
