  ...
  return (
    <MainPageHeaderContainer>
      ...
      <MainPageHeaderTop>
        ...
        <HeaderRight>{IsLogin ? <LogOut /> : <LogIn />}</HeaderRight>
      </MainPageHeaderTop>
      <StyledDiv
        position="static"
        width="100%"
      ...
      >
        <StyledDiv
          ...
          border="10px"
          bg={main.bg}
          color={main.font ? main.font : '#666666'}
          display="flex"
        ...
        <StyledDiv
          ...
          border="10px"
          bg={guide.bg}
          color={guide.font ? guide.font : '#666666'}
          display="flex"
          justify_content="center"
          align_item="center"
          text_align="center"
        ...
        <StyledDiv
          onClick={() => {
            pageChange(2), MatchingStatusRefresh();
          }}
          border="10px"
          bg={matching.bg}
          color={matching.font ? matching.font : '#666666'}
          display="flex"
          justify_content="center"
          align_item="center"
          text_align="center"
        ...
        <StyledDiv
          ...
          border="10px"
          bg={myinfo.bg}
          color={myinfo.font ? myinfo.font : '#666666'}
          display="flex"
          justify_content="center"
          align_item="center"
          text_align="center"
