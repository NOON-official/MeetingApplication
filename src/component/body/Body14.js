  ...
  return (
    <Container>
      <MobileBox>
        ...
        <StyledDiv top="65%" width="90%" height="15%" left="50%" display="flex" justify_content="center" align_item="center">
          <StyledText  size="25px" left="20%" text_align="center">
            미팅학개론을 이용하기 위해서는 <br/> 카카오톡 로그인이 필요해요.
          </StyledText>
        </StyledDiv>
        
          <StyledDiv height="auto"  top="86%" width="auto" left="50%">
            <KakaoLogin />
          </StyledDiv>
