...
const MbtiTest = () => {
  ...
  const result = React.useMemo(() => (compatibility >= 60 ? '궁합이 너무 좋아요' : '최악이에요'));
  const OnChange = (e) => {
  ...
  return (
    <Container>
      ...
      <div className="mbtiCombatibilityBox">
        ...
        <div>
          <span>우리팀원 MBTI</span>
          <StyledInput placeholder="mbti1" id="mbti1" onChange={OnChange}></StyledInput>
          <StyledInput placeholder="mbti2" id="mbti2" onChange={OnChange}></StyledInput>
          <StyledInput placeholder="mbti3" id="mbti3" onChange={OnChange}></StyledInput>
        </div>
        <div>
          <span>상대팀원 MBTI</span>
          <StyledInput placeholder="mbti4" id="mbti4" onChange={OnChange}></StyledInput>
          <StyledInput placeholder="mbti5" id="mbti5" onChange={OnChange}></StyledInput>
          <StyledInput placeholder="mbti6" id="mbti6" onChange={OnChange}></StyledInput>
        </div>
